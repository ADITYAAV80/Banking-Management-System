...
bool add_customer(int connectionFileDescriptor);
bool modify_customer(int connectionFileDescriptor);
bool change_password(int connectionFileDescriptor);
    ...
    if (login_admin(connectionFileDescriptor))
    {
        ...
        while (1)
        {
            ...
            case 4:
                ...
                break;
            case 5:
                add_customer(connectionFileDescriptor);
                break;
            case 6:
